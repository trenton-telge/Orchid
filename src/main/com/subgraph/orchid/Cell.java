...
public interface Cell {
	...
	int VPADDING = 128;
	int CERTS = 129;
	int AUTH_CHALLENGE = 130;
	int AUTHENTICATE = 131;
	int AUTHORIZE = 132;

	int ERROR_NONE = 0;
	int ERROR_PROTOCOL = 1;
	int ERROR_INTERNAL = 2;
	int ERROR_REQUESTED = 3;
	int ERROR_HIBERNATING = 4;
	int ERROR_RESOURCELIMIT = 5;
	int ERROR_CONNECTFAILED = 6;
	int ERROR_OR_IDENTITY = 7;
	int ERROR_OR_CONN_CLOSED = 8;
	int ERROR_FINISHED = 9;
	int ERROR_TIMEOUT = 10;
	int ERROR_DESTROYED = 11;
	int ERROR_NOSUCHSERVICE = 12;

	int ADDRESS_TYPE_HOSTNAME = 0x00;
	int ADDRESS_TYPE_IPV4     = 0x04;
	int ADRESS_TYPE_IPV6      = 0x06;
	 ...
	 */
	int CELL_PAYLOAD_LEN = CELL_LEN - CELL_HEADER_LEN;
