    ...
    static{
        ...
        try {
            ...
            for(ExportedCertificate exportedCertificate : ApplicationProperties.getAdditionalSslCertificates()){
                try (InputStream caInput = new BufferedInputStream(EnforceSslCertificates.class.getResourceAsStream(exportedCertificate.getPath() + exportedCertificate.getName() + "." + exportedCertificate.getExtension()))) {
