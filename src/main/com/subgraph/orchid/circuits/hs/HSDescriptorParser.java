...
public class HSDescriptorParser implements DocumentParser<HSDescriptor>{
    private static final Logger logger = Logger.getInstance(HSDescriptorParser.class);
    ...
    public DocumentParsingResult<HSDescriptor> parse() {
        final BasicDocumentParsingResult<HSDescriptor> result = new BasicDocumentParsingResult<>();
        parse(result);
        return result;
    }
    ...
    private void processIntroductionPoints() {
        ...
        parser.parse(new DocumentParsingResultHandler<>() {
